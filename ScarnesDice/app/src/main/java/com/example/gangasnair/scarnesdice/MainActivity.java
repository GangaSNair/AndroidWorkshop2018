package com.example.gangasnair.scarnesdice;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void rollButtonClick(View v){
        ...
        Text=userScoreText+scorePlayer+compScoreText+scoreComputer+userTurnScoreText+turnScorePlayer+compTurnScoreText+turnScoreComputer;
        text.setText(Text);
    }
